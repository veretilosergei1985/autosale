...
class Application_Model_CarSafetyMapper
{
    protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_CarSafety');
        }
    ...
    public function save(Application_Model_CarSafety $model)
    {
        $data = array(
            'car_id'    => $model->getCarId(),
            'safety_id'   => $model->getSafetyId(),
