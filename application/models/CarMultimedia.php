...
class Application_Model_CarMultimedia
{
    protected $_id;
    protected $_car_id;
    protected $_multimedia_id;
    protected $_mapper;
    ...
    public function setMultimediaId($id)
    {
        $this->_multimedia_id = (int) $id;
        return $this;
    }
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_CarMultimediaMapper());
        }
        return $this->_mapper;
    }
