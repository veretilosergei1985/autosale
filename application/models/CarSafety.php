...
class Application_Model_CarSafety
{
    protected $_id;
    protected $_car_id;
    protected $_safety_id;
    protected $_mapper;
    ...
    public function setSafetyId($id)
    {
        $this->_safety_id = (int) $id;
        return $this;
    }
    public function getSafetyId()
    {
        return $this->_safety_id;
    }
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_CarSafetyMapper());
        }
        return $this->_mapper;
    }
